...
/**
 *  \file       assys_contact.php
 *  \ingroup    college
 *  \brief      Tab for contacts linked to Assys
 */
...
$hookmanager->initHooks(array('assyscontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->college->assys->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Assys')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Assys"), -1, $object->picto);
