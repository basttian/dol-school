...
class Students extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_soc' => array('type'=>'integer:Societe:societe/class/societe.class.php:1', 'label'=>'Tutor', 'enabled'=>'1', 'position'=>50, 'notnull'=>-1, 'visible'=>1, 'index'=>1, 'css'=>'maxwidth500 widthcentpercentminusxx', 'help'=>"LinkToThirparty", 'validate'=>'1',),
  ...
  public function gestudenttutortab($idtutor){
     $rows = array();
     $resql=$this->db->query("select * from ".MAIN_DB_PREFIX."college_students where fk_soc=".(int)$idtutor." ");
     if ($resql)
     {
       $num = $this->db->num_rows($resql);
         $i = 0;
