 ...
 */
class doc_generic_students_odt extends ModelePDFStudents
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function __construct($db)
	{
		...
		$this->scandir = 'COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH'; // Name of constant that is used to save list of directories to scan
	...
	public function info($langs)
	{
		...
		$texte .= '<input type="hidden" name="param1" value="COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH">';
		$texte .= '<table class="nobordernopadding centpercent">';

		// List of directories area
		$texte .= '<tr><td>';
		$texttitle = $langs->trans("ListOfDirectories");
		$listofdir = explode(',', preg_replace('/[\r\n]+/', ',', trim($conf->global->COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH)));
		$listoffiles = array();
		...
		$texte .= $conf->global->COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH;
		$texte .= '</textarea>';
		...
		if (!empty($conf->global->COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH)) {
		...
		if ($nbofiles) {
			...
			foreach ($listoffiles as $file) {
				$texte .= '- '.$file['name'];
				$texte .= ' <a href="'.DOL_URL_ROOT.'/document.php?modulepart=doctemplates&file=college_students/'.urlencode(basename($file['name'])).'">'.img_picto('', 'listlight').'</a>';
		...
		$texte .= '<input type="hidden" value="COLLEGE_STUDENTS_ADDON_PDF_ODT_PATH" name="keyforuploaddir">';
