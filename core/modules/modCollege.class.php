...
class modCollege extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 8700000; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
