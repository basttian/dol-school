...
/**
 *  \file       inscriptions_agenda.php
 *  \ingroup    college
 *  \brief      Tab of events on Inscriptions
 */
...
$hookmanager->initHooks(array('inscriptionsagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Inscriptions"), -1, $object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnInscriptions"), '', '');
