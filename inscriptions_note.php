...
/**
 *  \file       inscriptions_note.php
 *  \ingroup    college
 *  \brief      Tab for notes on Inscriptions
 */
...
$hookmanager->initHooks(array('inscriptionsnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Inscriptions'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Inscriptions"), -1, $object->picto);
