...
$hookmanager->initHooks(array('notesnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Notes'), $help_url);
