...
/**
 *  \file       subject_note.php
 *  \ingroup    college
 *  \brief      Tab for notes on Subject
 */
...
$hookmanager->initHooks(array('subjectnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Subject'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Subject"), -1, $object->picto);
