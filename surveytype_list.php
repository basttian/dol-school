...
/**
 *   	\file       surveytype_list.php
 *		\ingroup    college
 *		\brief      List page for surveytype
 */
...
$hookmanager->initHooks(array('surveytypelist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Surveytype';
	$objectlabel = 'Surveytype';
...
//$help_url = "EN:Module_Surveytype|FR:Module_Surveytype_FR|ES:Módulo_Surveytype";
$help_url = '';
$title = $langs->trans("Surveytypes");
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/college/surveytype_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/college/surveytype_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendSurveytypeRef";
$modelmail = "surveytype";
$objecttmp = new Surveytype($db);
