...
/**
 * \file    test/phpunit/CollegeFunctionalTest.php
 * \ingroup college
 ...
 * @package Testcollege
 */
class CollegeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/college/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('college/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/college/admin/about.php');
		$this->authenticate();
		return $this->assertContains('college/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('collegewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCollege_CollegeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCollege_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
